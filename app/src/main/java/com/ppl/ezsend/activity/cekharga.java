...
import com.ppl.ezsend.adapter.CityAdapter;
import com.ppl.ezsend.adapter.ProvinceAdapter;
import com.ppl.ezsend.interfaces.ClickListener;
...
public class cekharga extends AppCompatActivity implements ClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bCekTarif.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(cekharga.this, ConstantPref.ERROR_COURIER, Toast.LENGTH_LONG).show();
                }
                else
                {
                    ...
                    if (weight.matches("")){
                        Toast.makeText(cekharga.this, ConstantPref.ERROR_WEIGHT, Toast.LENGTH_LONG).show();
                    } else {
                        Intent intent = new Intent(cekharga.this, CostActivity.class);
        ...
        BaseApps.getServices().getProvince(token).enqueue(new Callback<ProvinceResponse>() {
            ...
            public void onResponse(@NonNull Call<ProvinceResponse> call, @NonNull Response<ProvinceResponse> response) {
                if (response.isSuccessful()){
                    ...
                    provinceAdapter.setClickListener(cekharga.this);
                    provinceAdapter.notifyDataSetChanged();
                } else {
                    Toast.makeText(cekharga.this, ConstantPref.ERROR_NOT_SUCCESS, Toast.LENGTH_LONG).show();
                }
            }
        ...
        BaseApps.getServices().getCity(token, id).enqueue(new Callback<CityResponse>() {
            ...
            public void onResponse(@NonNull Call<CityResponse> call, Response<CityResponse> response) {
                if (response.isSuccessful()){
                    ...
                    cityAdapter.setClickListener(cekharga.this);
                } else {
                    Toast.makeText(cekharga.this, ConstantPref.ERROR_NOT_SUCCESS, Toast.LENGTH_LONG).show();
                }
            }
