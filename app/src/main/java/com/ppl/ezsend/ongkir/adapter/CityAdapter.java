package com.ppl.ezsend.ongkir.adapter;
...
import com.ppl.ezsend.cekharga;
import com.ppl.ezsend.R;
import com.ppl.ezsend.ongkir.CityActivity;
import com.ppl.ezsend.ongkir.model.Ongkir;
    ...
    public void onBindViewHolder(OngkirViewHolder holder, final int position) {
        ...
        holder.tvData.setOnClickListener(new View.OnClickListener(
            ...
            public void onClick(View view) {
                Intent i = new Intent(view.getContext(), cekharga.class);
